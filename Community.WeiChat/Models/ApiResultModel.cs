...
namespace Community.WeiChat
{
    ...
    //public class ExamReviewResult
    //{
    //    public CHW_EXAM Exam { get; set; }
    ...
    {
        public float ExamCredit { get; set; }
        public int ThemeCount { get; set; }
        public string Status { get; set; }
        public int ExamId { get; set; }
        public string ExamTitle { get; set; }
        public int HighScore { get; set; }
        public int LattemptNumber { get; set; }
        public int TimeLimit { get; set; }
        public int TriesLimit { get; set; }
        public DateTime StartTime { get; set; }
        public DateTime EndTime { get; set; }
        public int PassingScore { get; set; }
        public int SeeResultFlag { get; set; }
        public int SeeAnwserFlag { get; set; }
    }
